...
If nTipo <> 1
	...
	If lExistNFe
		...
		If FindFunction("U_CI_F001C").And.FindFunction("U_CI_A050")
			U_CI_A050( @oDanfe )
		End
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
//IATAN EM 09/04/2024 - REMOVER A INFORMAÇÃO DE DATA DE VALIDADE VAZIA QUANDO O PRODUTO FOR "IMB"
For nW := 1 To Len(oDet)
	conout("PRODUTO IMB = " + ALLTRIM(oDet[nW]:_PROD:_CPROD:TEXT))
	CONOUT("PRODUTO ="+oDet[nW]:_PROD:_XPROD:TEXT+"=")
	IF RIGHT(ALLTRIM(oDet[nW]:_PROD:_CPROD:TEXT), 3) == "IMB"
		oDet[nW]:_PROD:_XPROD:TEXT := STRTRAN(oDet[nW]:_PROD:_XPROD:TEXT, ALLTRIM("VALID.   /  /"), "")
	ENDIF
Next
