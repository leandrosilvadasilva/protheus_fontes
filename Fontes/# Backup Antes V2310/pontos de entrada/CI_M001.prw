...
*/
			...
			//IATAN EM 27/08/2022
			If !lBlind .AND. !IsInCallStack("U_GERADANFE")
			//If !lBlind
				If lErrSaldo
...
Static Function F001IniImp( oBoleto, oSetup, lExistBol, lBlind, aBanco, aTitulo, aSacado )
	...
	If oBoleto == Nil
		...
		//IATAN EM 27/8/2022
		If !lBlind .AND. !IsInCallStack("U_GERADANFE")// Se nao estiver sendo chamado via Web Service
