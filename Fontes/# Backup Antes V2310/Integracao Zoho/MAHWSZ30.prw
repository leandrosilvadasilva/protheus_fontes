...
WSRESTFUL MAHTABPREC DESCRIPTION "Tabela de Preco"

	WSDATA DA1_CODTAB AS STRING
    WSDATA DA1_JOB    AS STRING
    WSDATA DA1_CODPRO AS STRING
	WSMETHOD GET DESCRIPTION "Listar Tabela de Preco" WSSYNTAX "/MAHTABPREC" 
...
�����������������������������������������������������������������������������
*/
WSMETHOD GET WSRECEIVE DA1_CODTAB WSSERVICE MAHTABPREC
	...
	Conout('MAHTABPREC - Integracao Lista de Preco')
	...
	cQuery += " INNER JOIN DA1010 DA1 ON (SB1.B1_FILIAL=DA1.DA1_FILIAL AND SB1.B1_COD=DA1.DA1_CODPRO)  "
	cQuery += " INNER JOIN DA0010 DA0 ON (DA0.DA0_FILIAL=DA1.DA1_FILIAL AND DA0.DA0_CODTAB=DA1.DA1_CODTAB)  "
  ...
  /*
	...
	*/
	...
	Conout('MAHTABPREC - Verifique o parametro ou nenhum Item da Tabela a ser exibido.')
	...
	Conout('MAHTABPREC - Finalizacao Ok')
	EndIf
