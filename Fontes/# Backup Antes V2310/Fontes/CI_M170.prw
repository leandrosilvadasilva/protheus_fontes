...
// Exclusivo MA HOSPITALAR
	...
	If !TCCanOpen( "dTipoVendaFisca_Comercial" )
...
cScript += " Quantidade, PrecoVenda, ValorTotal, ValorIcms, ValorPis, ValorCofins, ValorIss, ValorCsll, "
