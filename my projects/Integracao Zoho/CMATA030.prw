...
IF lOk
	cCodCGC := StrTran( StrTran( StrTran( '45543915000180',"." ), "-" ),"/" )
	...
	Else
		...
		aAdd( aCliente, {"A1_CGC"    , "45543915000180"	  	    , Nil} )
		...
		MSExecAuto({|x,y| CRMA980(x,y)},aCliente,3) //3- Inclusão, 4- Alteração, 5- Exclusão
