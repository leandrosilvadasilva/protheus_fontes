...
WSMETHOD GET WSRECEIVE FILPED,NUMPED,DATPED WSSERVICE MAHSITPED
	...
	aAdd(aCampo, {"D2_EMISSAO","D2_EMISSAO"})
	aAdd(aCampo, {"C6_ENTREG","C6_ENTREG"})
	...
	cQuery += " ), "
	cQuery += " ITEMPED (C5_FILIAL, C5_NUM, C5_EMISSAO, C5_CODZHO, C5_LIBEROK, C5_ZTPLIBE, C6_PRODUTO, B1_DESC, C6_QTDVEN, C6_QTDENT, C6_NOTA, C6_ENTREG, C6_STPESTQ, C6_DATFAT, C9_BLEST, C9_BLCRED, C9_BLWMS,C6_ITEM,B1_CODZHO) AS ( "
	cQuery += " SELECT C5_FILIAL, C5_NUM, C5_EMISSAO, C5_CODZHO, C5_LIBEROK, C5_ZTPLIBE, C6_PRODUTO, B1_DESC, C6_QTDVEN, C6_QTDENT, C6_NOTA, C6_ENTREG, C6_STPESTQ, C6_DATFAT, C9_BLEST, C9_BLCRED, C9_BLWMS,C6_ITEM,B1_CODZHO  "
 	cQuery += " FROM SC5PED "
	...
	cQuery += " ), "
	cQuery += " ITEMFAT (IF_FILIAL, IF_NUM, IF_PRODUTO,IF_ITEMPV,D2_EMISSAO,IF_TOTAL,IF_VALFRE) AS ( "
	...
	cQuery += " ) "
	cQuery += " SELECT C5_FILIAL, C5_NUM, C5_CODZHO,H_SITUACAO,H_VALPED,H_VALFAT,H_VALCRE,H_VALEST,C6_PRODUTO, B1_DESC, C6_QTDENT, C6_NOTA,IF_VALFRE,IF_TOTAL,D2_EMISSAO,C6_ENTREG,B1_CODZHO, "
